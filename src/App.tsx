  ...
  <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm shadow-violet-900/5 transition-colors duration-500">
    <div className="flex justify-between items-center max-w-7xl mx-auto px-8 py-4">
      ...
      <div className="hidden md:flex gap-8 items-center">
        ...
        <a className={`font-semibold font-noto-serif italic text-lg tracking-tight transition-all duration-300 ${isActive("sobre-mi") ? "text-violet-900 border-b-2 border-green-200 pb-1" : "text-slate-600 hover:text-violet-600 hover:bg-violet-50/50 rounded-lg px-3 py-1"}`} href="#sobre-mi">Sobre mí</a>
